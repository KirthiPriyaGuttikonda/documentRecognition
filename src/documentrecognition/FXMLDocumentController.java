...
public class FXMLDocumentController implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        File f = fileChooser.showOpenDialog(ImageToLabel.manasa);
        String fn = f.getPath();
        try {
            label.setText(kirthi(fn));
    ...
    public static String kirthi(String file) throws FileNotFoundException, IOException {
        //Denoising
